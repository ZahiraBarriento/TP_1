...
void hardCode(eEmployee* x)
{
    ...
    eEmployee y[] =
    {
        {1, "Carlos", "Lopez", 16593, 4},
        {2, "Mabel", "Gonzalez", 20000, 3},
        {3, "Ruperto", "Perez", 26390, 5},
        {4, "Ernesto", "Lopez", 50000, 2},
        {5, "Juan", "Pablo", 100000, 1},
        {6, "Jose", "Cespedes", 986532, 2},
        {7, "Alberto", "Cara", 75482, 1}
    };
